			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right">
						...
						<li>
							<a class="page-scroll" href="<?php echo base_url();?>#services">Anúncios</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php echo base_url();?>#portfolio">Cadastros</a>
						</li>
						<li>
							<a class="page-scroll" href="<?php echo base_url();?>#team">Revisão</a>
						</li>
						<li>
